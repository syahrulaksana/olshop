        ...
        <div class="card-body">
          ...
          ', '</h5></div>');
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="ket" class="form-control" placeholder="Enter keterangan gambar..." value="<?= set_value('ket') ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <a href="<?= base_url('gambarbarang'); ?>" class="btn btn-primary">Kembali</a>
            </div>
            ...
            <div class="row">
                <?php foreach ($gambar as $key => $value) : ?>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <img src="<?= base_url('assets/gambarbarang/' . $value->gambar); ?>" id="gambar_load" width="225px" height="200px">
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <h5>Apakah anda yakin ingi menghapus <?= $value->ket; ?>?</h5>
