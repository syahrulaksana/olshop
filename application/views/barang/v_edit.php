        ...
        <div class="card-body">
          ...
          ', '</h5></div>');
            ...
            <div class="form-group">
                ...
                <input name="nama_barang" class="form-control" placeholder="Enter nama barang..." value="<?= $barang->nama_barang ?>">
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Harga</label>
                        <input name="harga" class="form-control" placeholder="Enter harga..." value="<?= $barang->harga ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Berat(gr)</label>
                        <input type="number" name="berat" class="form-control" placeholder="Enter berat satuan gram..." value="<?= $barang->berat ?>">
                    </div>
                </div>
            </div>
